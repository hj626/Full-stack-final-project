...
const Footer = () => {
    return (
        ...
        <div className="container py-5">
            ...
            <div className="col-lg-3 col-md-6">
                <h4 className="text-light mb-4">바로가기</h4>
                <a className="btn btn-link" href="#">가격정보</a>
                <a className="btn btn-link" href="#">농산물</a>
                <a className="btn btn-link" href="#">판매 정보</a>
                <a className="btn btn-link" href="#">제품정보</a>
                <a className="btn btn-link" href="#">고객센터</a>
            </div>
            {/* <div className="col-lg-3 col-md-6">
