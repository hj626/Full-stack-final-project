    ...
    return (
        ...
        <div className="container">
            ...
            <div className="col-lg-6 wow fadeIn" data-wow-delay="0.1s">
                <h1 className="">최근 가격변동</h1>
                <div className="about-img position-relative overflow-hidden p-5 pe-0" style={{width: '1000px'}}>
                <img className="img-fluid w-100" src="/img/ex.jpg" alt="About" />
                </div>
            </div>
